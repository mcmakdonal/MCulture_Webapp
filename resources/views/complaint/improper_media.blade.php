        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="form-group">
                    ...
                    <select class="form-control use-select2" id="media_type_id" name="media_type_id">
                        @foreach($media_type as $k => $v)
                            <option value="{{$v->media_type_id}}">{{$v->media_type_name}}</option>
                        @endforeach
                    <select>
                </div>
            </div>
