...
<section id="complaintform">
    ...
    <div class="container">
        ...
        {!! Form::open(['url' => '/form/complaintform','class' => 'form-auth-small', 'method' => 'post','id' => 'form-form','files'=> true] ) !!}
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="form-group">
                    ...
                    <select class="form-control use-select2" id="CPTYPE_ID" name="CPTYPE_ID" onchange="change_complaintform();">
                        @foreach ($get_cptype as $value)
                        <option value="{{$value->cptype_id}}">{{$value->cptype_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="form-group">
                ...
                <select class="form-control" id="CPMEDIATYPE_ID" name="CPMEDIATYPE_ID">
                    @foreach ($get_mediatype as $value)
                    <option value="{{$value->cpmediatype_id}}">{{$value->cpmediatype_name}}</option>
                    @endforeach
                </select>
            </div>
        </div>
