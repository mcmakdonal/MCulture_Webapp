                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control number-on" name="communicant_identification" id="communicant_identification" placeholder="เลขบัตรประจำตัวประชาชน" maxlength="13">
                                    </div>
                                </div>
                            </div>
                        </div>
