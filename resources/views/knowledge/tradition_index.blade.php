...
@section('content')
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-small btn-info" href="{{ url('/km/tradition/' . $v->content_id . '/edit') }}">แก้ไข</a>
            </td>
            <td>
                <a class="btn btn-small btn-danger" onclick="destroy(this,'/km/tradition','{{ $v->content_id }}')" >ลบ</a>
            </td>
        </tr>
        @endforeach
    </tbody>
